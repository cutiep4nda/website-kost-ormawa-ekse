...
const kostData = [
    {
        ...
        images: [
            "images/premium/tasima/tasimaadaro1.jpg",
            "images/premium/tasima/tasimaadaro2.jpg",
            "images/premium/tasima/tasimaadaro3.jpg",
            "images/premium/tasima/tasimaadaro4.jpg",
        ],
        desk_singkat:
            "Tempat tinggal nyaman dan aman dengan fasilitas lengkap, pilihan AC atau non-AC sesuai kebutuhan Anda.",
        deskripsi:
            "New Tasima menawarkan kenyamanan ekstra dengan berbagai fasilitas unggulan. Setiap kamar berukuran lebih luas (3x4 meter) dan dilengkapi dengan AC, closet duduk, serta furnitur baru seperti tempat tidur, lemari, dan meja yang lebih besar. Area parkir luas dan dapat digunakan untuk mobil. Tersedia juga pilihan kamar untuk dua orang dalam satu ruangan, cocok bagi yang ingin tinggal bersama teman.",
        facilities: [
    ...
    },
    {
        ...
        desk_singkat:
            "Tempat tinggal nyaman dan aman dengan fasilitas lengkap, pilihan AC atau non-AC sesuai kebutuhan Anda.",
        deskripsi:
            "New Tasima 2 menawarkan kenyamanan ekstra dengan berbagai fasilitas unggulan. Setiap kamar berukuran lebih luas (3x4 meter), closet duduk, serta furnitur baru seperti tempat tidur, lemari, dan meja yang lebih besar. Area parkir luas dan dapat digunakan untuk mobil. Tersedia juga pilihan kamar untuk dua orang dalam satu ruangan, cocok bagi yang ingin tinggal bersama teman.",
        facilities: [
            { name: "Kasur", icon: FaBed },
            { name: "Lemari", icon: FaBox }, // FaBox mewakili storage/lemari
            { name: "Cermin", icon: GiMirrorMirror },
    ...
    return (
        <div className="relative md:h-screen w-full ">
            ...
            <div className="absolute inset-0 z-0">
                <img
                    src="images/premium/tasima/tasimaadaro2.jpg"
                    alt="Kos Hero"
