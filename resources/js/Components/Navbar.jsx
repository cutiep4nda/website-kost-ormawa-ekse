        ...
        <div className="bg-birumuda1 w-full h-24 px-10">
            <div className="flex justify-between items-center h-full">
                ...
                <div className="flex items-center gap-6 p-4 w-full max-w-md">
                    ...
                    {/* Panel Filter */}
                    {showFilter && (
                        <div className="absolute z-50 top-24 right-0 bg-white shadow-md rounded-md p-6 w-[400px]">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-3 gap-6 text-xs text-center px-6">
                                    {[
                                        "K. Mandi Dalam",
                                        "AC",
                                        "Kasur",
                            ...
                            <button
                                className="py-2 w-full bg-birumuda2 rounded-2xl mt-6 font-bold text-white
                            hover:bg-biru transition duration-300"
                            >
                                Cari
                            </button>
                        </div>
